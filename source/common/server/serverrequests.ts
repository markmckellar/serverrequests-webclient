...
export class ServerRequests extends ServerRequestsBase {
    ...
    {	
		let serverPromise = this.getServerPromiseWithArgs(serviceUrl,urlArgs,new Map<string,string>());
    ...
    {	
        console.log("ServerRequests:executeServerPostJson:loadingMessage="+loadingMessage+":serviceUrl="+serviceUrl);
